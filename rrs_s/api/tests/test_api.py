...
class ApiTestCase(APITestCase):
    ...
    def test_post_comments(self):
        ...
        response = c.post(url, data={'post': f'{post1.pk}', 'author': 'maxek', 'content': 'real keks'})
        self.assertEqual(status.HTTP_201_CREATED, response.status_code)
    ...
    def test_post_posts(self):
        ...
        response = c.post(url, data={'rubric': f'{rubric.pk}', 'title': 'keks', 'content': 'real keks', 'image': '', 'author': 'maxek', })
        self.assertEqual(status.HTTP_201_CREATED, response.status_code)